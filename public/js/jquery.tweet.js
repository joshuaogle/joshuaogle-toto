(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["joshuaogle"],              // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
    ...
    return this.each(function(){
      ...
      $.getJSON(build_url(), function(data){
        ...
        $.each((data.results || data), function(i,item){
          ...
          var date = '<span class="feed-time">'+relative_time(item.created_at)+'</span>';

          // until we create a template option, arrange the items below to alter a tweet's display.
          list.append('<li><p>' + avatar + join + text + date + '</p></li>');
